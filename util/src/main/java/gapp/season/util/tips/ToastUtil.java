...
public class ToastUtil {
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(sApplication.getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(sApplication.getResources().getString(resId), args), duration);
    }
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) sApplication.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private static final class ApplicationContextWrapperForApi25 extends ContextWrapper {
        ...
        private static final class WindowManagerWrapper implements WindowManager {
            ...
            private WindowManagerWrapper(@NonNull WindowManager mBase) {
                this.mBase = mBase;
            }
